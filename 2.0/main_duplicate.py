    ...
    if(user_input1=='1'):
        ...
        if(user_input3=='1'):
            ...
            while True:
                ...
                print("5) Video Details")
                print("6) Change the number of videos on the graph")
                print("7) Go Back\n")
                print("Enter The Number Corresponding to Your Choice: ")
                graph_input=input()
                ...
                #     x_axises.append(x_axis)
                #     y_axises.append(y_axis)
                #     y_labels=['Views','Likes','Comments']
                #     legends=['Views Count','Likes Count','Comments Count']
                #     title=['Total Views for Each Published Video','Total Likes for Each Published Video','Total Comments for Each Published Video']
                #     multi_plot(x_axises,y_axises,y_labels,legends,title)
